...
class Api::V1::RentalAgreementsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create api_v1_rental_agreement" do
    assert_difference("Api::V1::RentalAgreement.count") do
      post api_v1_rental_agreements_url, params: { api_v1_rental_agreement: { content: @api_v1_rental_agreement.content, title: @api_v1_rental_agreement.title } }, as: :json
    end
  ...
  test "should update api_v1_rental_agreement" do
    patch api_v1_rental_agreement_url(@api_v1_rental_agreement), params: { api_v1_rental_agreement: { content: @api_v1_rental_agreement.content, title: @api_v1_rental_agreement.title } }, as: :json
    assert_response :success
  end
