...
class Api::V1::ReviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_review" do
    assert_difference("Api::V1::Review.count") do
      post api_v1_reviews_url, params: { api_v1_review: { content: @api_v1_review.content, title: @api_v1_review.title } }, as: :json
    end
  ...
  test "should update api_v1_review" do
    patch api_v1_review_url(@api_v1_review), params: { api_v1_review: { content: @api_v1_review.content, title: @api_v1_review.title } }, as: :json
    assert_response :success
  end
